...
CREATE TABLE IF NOT EXISTS whatsapp_templates (
  ...
  trigger_event VARCHAR(100) NOT NULL, -- 'booking_confirmed', 'booking_completed', 'booking_cancelled', 'booking_pending'
...
CREATE TABLE IF NOT EXISTS whatsapp_settings (
  ...
  api_key VARCHAR(255),
  api_provider VARCHAR(100) DEFAULT 'whatsapp_web', -- 'whatsapp_web', 'twilio', 'whatsapp_business_api'
